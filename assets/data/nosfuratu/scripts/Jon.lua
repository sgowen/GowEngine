local function isRabbit()
    ...
    return s == "IDLE" or s == "RUNNING" or s == "JUMPING" or s == "FALLING" or s == "DOUBLE_JUMPING" or s == "LANDING" or s == "DRILL_STOMPING" or s == "LANDING_ROLL" or s == "WARMING_UP" or s == "PUNCHING" or s == "DRILLING" or s == "ATTEMPTING_TO_TRANSFORM" or s == "CANCELING_ATTEMPT_TO_TRANSFORM" or s == "REVERTING" or s == "RABBIT_DEATH"
end
...
local function isMovementInputAllowed()
    ...
    return s == "IDLE" or s == "RUNNING" or s == "JUMPING" or s == "FALLING" or s == "DOUBLE_JUMPING" or s == "LANDING" or s == "WARMING_UP" or s == "VAMPIRE_IDLE" or s == "VAMPIRE_RUNNING" or s == "VAMPIRE_DOUBLE_JUMPING" or s == "VAMPIRE_GLIDING" or s == "VAMPIRE_FALLING" or s == "VAMPIRE_LANDING"
end

local function isAttackInputAllowed()
    local s = state()

    return s == "IDLE" or s == "RUNNING" or s == "JUMPING" or s == "FALLING" or s == "DOUBLE_JUMPING" or s == "WARMING_UP"
end

local function isJumpInputAllowed()
    local s = state()

    return s == "IDLE" or s == "RUNNING" or s == "JUMPING" or s == "FALLING" or s == "DOUBLE_JUMPING" or s == "LANDING" or s == "DRILL_STOMPING" or s == "LANDING_ROLL" or s == "WARMING_UP" or s == "VAMPIRE_IDLE" or s == "VAMPIRE_RUNNING" or s == "VAMPIRE_JUMPING" or s == "VAMPIRE_DOUBLE_JUMPING" or s == "VAMPIRE_GLIDING" or s == "VAMPIRE_FALLING" or s == "VAMPIRE_LANDING"
end

local function isAbilityInputAllowed()
    local s = state()

    return s == "IDLE" or s == "RUNNING" or s == "JUMPING" or s == "FALLING" or s == "DOUBLE_JUMPING" or s == "LANDING" or s == "WARMING_UP" or s == "VAMPIRE_IDLE" or s == "VAMPIRE_RUNNING" or s == "VAMPIRE_JUMPING" or s == "VAMPIRE_DOUBLE_JUMPING" or s == "VAMPIRE_GLIDING" or s == "VAMPIRE_FALLING" or s == "VAMPIRE_LANDING"
end
...
local function canCurrentStateBeInterruptedByFalling()
    ...
    return s == "IDLE" or s == "RUNNING" or s == "JUMPING" or s == "DOUBLE_JUMPING" or s == "LANDING" or s == "LANDING_ROLL" or s == "WARMING_UP" or s == "DRILLING" or s == "VAMPIRE_IDLE" or s == "VAMPIRE_RUNNING" or s == "VAMPIRE_JUMPING" or s == "VAMPIRE_DOUBLE_JUMPING" or s == "VAMPIRE_LANDING" or s == "VAMPIRE_DASH_COMPLETED"
end

local function canCurrentStateBeInterruptedByLanding()
    local s = state()

    return s == "FALLING" or s == "VAMPIRE_GLIDING" or s == "VAMPIRE_FALLING"
end
...
local function needsToResolveNewStateOnceAnimationEnds()
    ...
    return s == "JUMPING" or s == "DOUBLE_JUMPING" or s == "LANDING" or s == "LANDING_ROLL" or s == "PUNCHING" or s == "DRILLING" or s == "TRANSFORMING" or s == "CANCELING_ATTEMPT_TO_TRANSFORM" or s == "DRILLING" or s == "VAMPIRE_JUMPING" or s == "VAMPIRE_LANDING" or s == "REVERTING" or s == "CANCELING_ATTEMPT_TO_REVERT" or s == "VAMPIRE_DASH_COMPLETED" or s == "RABBIT_DEATH" or s == "VAMPIRE_DEATH"
end
...
local function processAttackInput(inputState)
    ...
    if isRabbit() and state ~= "PUNCHING" and isInputAttack and not wasInputAttack then
        setState("PUNCHING")
    end
end
...
local function processAbilityInput(inputState)
    ...
    if isRabbit() then
        if isGrounded() then
            if s ~= "DRILLING" and isInputAbility and not wasInputAbility then
                setState("DRILLING")
            end
        else
            if s ~= "DRILL_STOMPING" and isInputAbility and not wasInputAbility then
    ...
    if isVampire() then
        if s ~= "VAMPIRE_DASHING" and isInputAbility and not wasInputAbility then
...
local function processWarmingUpInput(inputState)
    ...
    if isRabbit() and state ~= "WARMING_UP" and isInputWarmingUp and not wasInputWarmingUp then
        setState("WARMING_UP")
    end
end
...
local function processSpecialInput(inputState)
    ...
    if s == attemptingToTransformState then
        ...
        if isInputSpecial and not wasInputSpecial then
...
function onUpdate(numMovesProcessed)
    ...
    if s == "ATTEMPTING_TO_TRANSFORM" and st == animationNumFrames() then
    ...
    -- Vampire
    if s == "VAMPIRE_DOUBLE_JUMPING" and st == animationNumFrames() then
        setState("VAMPIRE_GLIDING")
    end

    if s == "VAMPIRE_DASHING" and st == animationNumFrames() then
        setState("VAMPIRE_DASH_COMPLETED")
        setVelocityX(0)
        setZeroGravity(false)
    end

    if s == "ATTEMPTING_TO_REVERT" and st == animationNumFrames() then
        setState("REVERTING")
        setNetworkBool("isReleasingShockwave", true)
        setNetworkUInt16("shockwaveStartTime", numMovesProcessed)
        setSlowed(false)
    ...
    if canCurrentStateBeInterruptedByFalling() and not isGrounded() and getVelocityY() < 0 then
        local doubleJumpingState = "DOUBLE_JUMPING"
        local fallingState = "FALLING"
